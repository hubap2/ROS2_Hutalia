...
static const _HedgePositionAddressed_type_support_symbol_names_t _HedgePositionAddressed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, marvelmind_ros2_msgs, msg, HedgePositionAddressed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, marvelmind_ros2_msgs, msg, HedgePositionAddressed)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, marvelmind_ros2_msgs, msg, HedgePositionAddressed)() {
  return &::marvelmind_ros2_msgs::msg::rosidl_typesupport_c::HedgePositionAddressed_message_type_support_handle;
}
