...
marvelmind_ros2_msgs__msg__HedgePositionAngle__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  marvelmind_ros2_msgs__msg__HedgePositionAngle * msg = (marvelmind_ros2_msgs__msg__HedgePositionAngle *)allocator.allocate(sizeof(marvelmind_ros2_msgs__msg__HedgePositionAngle), allocator.state);
  if (!msg) {
    return NULL;
  }
...
marvelmind_ros2_msgs__msg__HedgePositionAngle__Sequence__init(marvelmind_ros2_msgs__msg__HedgePositionAngle__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (marvelmind_ros2_msgs__msg__HedgePositionAngle *)allocator.zero_allocate(size, sizeof(marvelmind_ros2_msgs__msg__HedgePositionAngle), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  marvelmind_ros2_msgs__msg__HedgePositionAngle__Sequence * array = (marvelmind_ros2_msgs__msg__HedgePositionAngle__Sequence *)allocator.allocate(sizeof(marvelmind_ros2_msgs__msg__HedgePositionAngle__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  marvelmind_ros2_msgs__msg__HedgePositionAngle__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    marvelmind_ros2_msgs__msg__HedgePositionAngle * data =
      (marvelmind_ros2_msgs__msg__HedgePositionAngle *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!marvelmind_ros2_msgs__msg__HedgePositionAngle__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          marvelmind_ros2_msgs__msg__HedgePositionAngle__fini(&output->data[i]);
        }
        return false;
      }
    }
