...
enum
{
  marvelmind_ros2_msgs__srv__MarvelmindAPI_Event__request__MAX_SIZE = 1
};
// response
enum
{
  marvelmind_ros2_msgs__srv__MarvelmindAPI_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/MarvelmindAPI in the package marvelmind_ros2_msgs.
typedef struct marvelmind_ros2_msgs__srv__MarvelmindAPI_Event
{
  service_msgs__msg__ServiceEventInfo info;
  marvelmind_ros2_msgs__srv__MarvelmindAPI_Request__Sequence request;
  marvelmind_ros2_msgs__srv__MarvelmindAPI_Response__Sequence response;
} marvelmind_ros2_msgs__srv__MarvelmindAPI_Event;

// Struct for a sequence of marvelmind_ros2_msgs__srv__MarvelmindAPI_Event.
typedef struct marvelmind_ros2_msgs__srv__MarvelmindAPI_Event__Sequence
{
