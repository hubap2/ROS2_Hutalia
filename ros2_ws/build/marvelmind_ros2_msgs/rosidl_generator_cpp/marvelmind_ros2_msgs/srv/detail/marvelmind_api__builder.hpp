...
class Init_MarvelmindAPI_Event_response
{
public:
  explicit Init_MarvelmindAPI_Event_response(::marvelmind_ros2_msgs::srv::MarvelmindAPI_Event & msg)
  : msg_(msg)
  {}
  ::marvelmind_ros2_msgs::srv::MarvelmindAPI_Event response(::marvelmind_ros2_msgs::srv::MarvelmindAPI_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::marvelmind_ros2_msgs::srv::MarvelmindAPI_Event msg_;
};

class Init_MarvelmindAPI_Event_request
{
public:
  explicit Init_MarvelmindAPI_Event_request(::marvelmind_ros2_msgs::srv::MarvelmindAPI_Event & msg)
  : msg_(msg)
  {}
  Init_MarvelmindAPI_Event_response request(::marvelmind_ros2_msgs::srv::MarvelmindAPI_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_MarvelmindAPI_Event_response(msg_);
  }
...
class Init_MarvelmindAPI_Event_info
{
public:
  Init_MarvelmindAPI_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_MarvelmindAPI_Event_request info(::marvelmind_ros2_msgs::srv::MarvelmindAPI_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_MarvelmindAPI_Event_request(msg_);
  }
...
template<>
inline
auto build<::marvelmind_ros2_msgs::srv::MarvelmindAPI_Event>()
{
  return marvelmind_ros2_msgs::srv::builder::Init_MarvelmindAPI_Event_info();
}
