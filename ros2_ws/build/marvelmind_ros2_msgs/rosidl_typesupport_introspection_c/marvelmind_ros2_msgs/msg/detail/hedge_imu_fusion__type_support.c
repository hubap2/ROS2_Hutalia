...
void marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_init_function(
...
void marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_fini_function(void * message_memory)
{
  marvelmind_ros2_msgs__msg__HedgeImuFusion__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_message_member_array[14] = {
  {
    "timestamp_ms",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_message_members = {
  ...
  marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_message_member_array,  // message members
  marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_init_function,  // function to initialize message memory (memory has to be allocated)
  marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_message_type_support_handle = {
  0,
  &marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, marvelmind_ros2_msgs, msg, HedgeImuFusion)() {
  if (!marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_message_type_support_handle.typesupport_identifier) {
    marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &marvelmind_ros2_msgs__msg__HedgeImuFusion__rosidl_typesupport_introspection_c__HedgeImuFusion_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
