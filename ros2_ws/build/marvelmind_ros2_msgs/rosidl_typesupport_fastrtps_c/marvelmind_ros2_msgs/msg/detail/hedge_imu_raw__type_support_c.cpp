...
bool cdr_serialize_marvelmind_ros2_msgs__msg__HedgeImuRaw(
  const marvelmind_ros2_msgs__msg__HedgeImuRaw * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marvelmind_ros2_msgs
bool cdr_deserialize_marvelmind_ros2_msgs__msg__HedgeImuRaw(
  eprosima::fastcdr::Cdr & cdr,
  marvelmind_ros2_msgs__msg__HedgeImuRaw * ros_message)
{
  // Field name: timestamp_ms
  {
    cdr >> ros_message->timestamp_ms;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = marvelmind_ros2_msgs__msg__HedgeImuRaw;
    is_plain =
      (
      offsetof(DataType, compass_z) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marvelmind_ros2_msgs
bool cdr_serialize_key_marvelmind_ros2_msgs__msg__HedgeImuRaw(
  const marvelmind_ros2_msgs__msg__HedgeImuRaw * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp_ms
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marvelmind_ros2_msgs
size_t get_serialized_size_key_marvelmind_ros2_msgs__msg__HedgeImuRaw(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HedgeImuRaw__ros_msg_type * ros_message = static_cast<const _HedgeImuRaw__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marvelmind_ros2_msgs
size_t max_serialized_size_key_marvelmind_ros2_msgs__msg__HedgeImuRaw(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const marvelmind_ros2_msgs__msg__HedgeImuRaw * ros_message = static_cast<const marvelmind_ros2_msgs__msg__HedgeImuRaw *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_marvelmind_ros2_msgs__msg__HedgeImuRaw(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  marvelmind_ros2_msgs__msg__HedgeImuRaw * ros_message = static_cast<marvelmind_ros2_msgs__msg__HedgeImuRaw *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_marvelmind_ros2_msgs__msg__HedgeImuRaw(cdr, ros_message);
}
...
static size_t _HedgeImuRaw__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_marvelmind_ros2_msgs__msg__HedgeImuRaw(
