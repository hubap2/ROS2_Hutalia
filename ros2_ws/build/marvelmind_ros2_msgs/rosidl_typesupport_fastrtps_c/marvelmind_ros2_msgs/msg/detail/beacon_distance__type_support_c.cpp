...
bool cdr_serialize_marvelmind_ros2_msgs__msg__BeaconDistance(
  const marvelmind_ros2_msgs__msg__BeaconDistance * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marvelmind_ros2_msgs
bool cdr_deserialize_marvelmind_ros2_msgs__msg__BeaconDistance(
  eprosima::fastcdr::Cdr & cdr,
  marvelmind_ros2_msgs__msg__BeaconDistance * ros_message)
{
  // Field name: address_hedge
  {
    cdr >> ros_message->address_hedge;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = marvelmind_ros2_msgs__msg__BeaconDistance;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marvelmind_ros2_msgs
bool cdr_serialize_key_marvelmind_ros2_msgs__msg__BeaconDistance(
  const marvelmind_ros2_msgs__msg__BeaconDistance * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: address_hedge
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marvelmind_ros2_msgs
size_t get_serialized_size_key_marvelmind_ros2_msgs__msg__BeaconDistance(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BeaconDistance__ros_msg_type * ros_message = static_cast<const _BeaconDistance__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_marvelmind_ros2_msgs
size_t max_serialized_size_key_marvelmind_ros2_msgs__msg__BeaconDistance(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const marvelmind_ros2_msgs__msg__BeaconDistance * ros_message = static_cast<const marvelmind_ros2_msgs__msg__BeaconDistance *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_marvelmind_ros2_msgs__msg__BeaconDistance(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  marvelmind_ros2_msgs__msg__BeaconDistance * ros_message = static_cast<marvelmind_ros2_msgs__msg__BeaconDistance *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_marvelmind_ros2_msgs__msg__BeaconDistance(cdr, ros_message);
}
...
static size_t _BeaconDistance__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_marvelmind_ros2_msgs__msg__BeaconDistance(
