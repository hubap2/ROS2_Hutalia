  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = marvelmind_ros2_msgs__msg__HedgePositionAngle;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const marvelmind_ros2_msgs__msg__HedgePositionAngle * ros_message = static_cast<const marvelmind_ros2_msgs__msg__HedgePositionAngle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_marvelmind_ros2_msgs__msg__HedgePositionAngle(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  marvelmind_ros2_msgs__msg__HedgePositionAngle * ros_message = static_cast<marvelmind_ros2_msgs__msg__HedgePositionAngle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_marvelmind_ros2_msgs__msg__HedgePositionAngle(cdr, ros_message);
}
...
static size_t _HedgePositionAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_marvelmind_ros2_msgs__msg__HedgePositionAngle(
