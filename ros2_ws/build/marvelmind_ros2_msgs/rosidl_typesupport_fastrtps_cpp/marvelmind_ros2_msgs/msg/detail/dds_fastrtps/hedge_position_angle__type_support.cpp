...
#include "marvelmind_ros2_msgs/msg/detail/hedge_position_angle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const marvelmind_ros2_msgs::msg::HedgePositionAngle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  marvelmind_ros2_msgs::msg::HedgePositionAngle & ros_message)
{
  // Member: address
  cdr >> ros_message.address;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_marvelmind_ros2_msgs
max_serialized_size_HedgePositionAngle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = marvelmind_ros2_msgs::msg::HedgePositionAngle;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_marvelmind_ros2_msgs
max_serialized_size_key_HedgePositionAngle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const marvelmind_ros2_msgs::msg::HedgePositionAngle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<marvelmind_ros2_msgs::msg::HedgePositionAngle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HedgePositionAngle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const marvelmind_ros2_msgs::msg::HedgePositionAngle *>(
...
static size_t _HedgePositionAngle__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_HedgePositionAngle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HedgePositionAngle__callbacks = {
...
static rosidl_message_type_support_t _HedgePositionAngle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HedgePositionAngle__callbacks,
...
{
  return &marvelmind_ros2_msgs::msg::typesupport_fastrtps_cpp::_HedgePositionAngle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marvelmind_ros2_msgs, msg, HedgePositionAngle)() {
  return &marvelmind_ros2_msgs::msg::typesupport_fastrtps_cpp::_HedgePositionAngle__handle;
}
