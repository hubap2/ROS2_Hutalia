  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = marvelmind_ros2_msgs::msg::HedgePosition;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_marvelmind_ros2_msgs
max_serialized_size_key_HedgePosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _HedgePosition__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_HedgePosition(full_bounded, is_plain, 0);
