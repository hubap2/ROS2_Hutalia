...
#include "marvelmind_ros2_msgs/msg/detail/hedge_quality__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = marvelmind_ros2_msgs::msg::HedgeQuality;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_marvelmind_ros2_msgs
max_serialized_size_key_HedgeQuality(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _HedgeQuality__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HedgeQuality(full_bounded, is_plain, 0);
...
{
  return &marvelmind_ros2_msgs::msg::typesupport_fastrtps_cpp::_HedgeQuality__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marvelmind_ros2_msgs, msg, HedgeQuality)() {
  return &marvelmind_ros2_msgs::msg::typesupport_fastrtps_cpp::_HedgeQuality__handle;
}
