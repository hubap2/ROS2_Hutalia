...
#include "marvelmind_ros2_msgs/srv/detail/marvelmind_api__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = marvelmind_ros2_msgs::srv::MarvelmindAPI_Request;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_marvelmind_ros2_msgs
max_serialized_size_key_MarvelmindAPI_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MarvelmindAPI_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MarvelmindAPI_Request(full_bounded, is_plain, 0);
...
{
  return &marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::_MarvelmindAPI_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = marvelmind_ros2_msgs::srv::MarvelmindAPI_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_marvelmind_ros2_msgs
max_serialized_size_key_MarvelmindAPI_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MarvelmindAPI_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MarvelmindAPI_Response(full_bounded, is_plain, 0);
...
{
  return &marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::_MarvelmindAPI_Response__handle;
}
...
// functions for marvelmind_ros2_msgs::srv::MarvelmindAPI_Request already declared above

// functions for marvelmind_ros2_msgs::srv::MarvelmindAPI_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_marvelmind_ros2_msgs
cdr_serialize(
  const marvelmind_ros2_msgs::srv::MarvelmindAPI_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  marvelmind_ros2_msgs::srv::MarvelmindAPI_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::get_serialized_size(
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_marvelmind_ros2_msgs
max_serialized_size_MarvelmindAPI_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_MarvelmindAPI_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_MarvelmindAPI_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = marvelmind_ros2_msgs::srv::MarvelmindAPI_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_marvelmind_ros2_msgs
max_serialized_size_key_MarvelmindAPI_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_MarvelmindAPI_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_MarvelmindAPI_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const marvelmind_ros2_msgs::srv::MarvelmindAPI_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<marvelmind_ros2_msgs::srv::MarvelmindAPI_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MarvelmindAPI_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const marvelmind_ros2_msgs::srv::MarvelmindAPI_Event *>(
...
static size_t _MarvelmindAPI_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MarvelmindAPI_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MarvelmindAPI_Event__callbacks = {
  "marvelmind_ros2_msgs::srv",
  "MarvelmindAPI_Event",
...
static rosidl_message_type_support_t _MarvelmindAPI_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MarvelmindAPI_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::_MarvelmindAPI_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marvelmind_ros2_msgs, srv, MarvelmindAPI_Event)() {
  return &marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::_MarvelmindAPI_Event__handle;
}
...
static const rosidl_service_type_support_t _MarvelmindAPI__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MarvelmindAPI__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<marvelmind_ros2_msgs::srv::MarvelmindAPI_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<marvelmind_ros2_msgs::srv::MarvelmindAPI_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<marvelmind_ros2_msgs::srv::MarvelmindAPI_Event>(),
...
{
  return &marvelmind_ros2_msgs::srv::typesupport_fastrtps_cpp::_MarvelmindAPI__handle;
}
