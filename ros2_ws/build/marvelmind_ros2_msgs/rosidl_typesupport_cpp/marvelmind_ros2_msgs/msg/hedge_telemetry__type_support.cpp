...
static const _HedgeTelemetry_type_support_symbol_names_t _HedgeTelemetry_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marvelmind_ros2_msgs, msg, HedgeTelemetry)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, marvelmind_ros2_msgs, msg, HedgeTelemetry)),
  }
};
...
{
  return &::marvelmind_ros2_msgs::msg::rosidl_typesupport_cpp::HedgeTelemetry_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, marvelmind_ros2_msgs, msg, HedgeTelemetry)() {
  return get_message_type_support_handle<marvelmind_ros2_msgs::msg::HedgeTelemetry>();
}
