...
static const _HedgePosition_type_support_symbol_names_t _HedgePosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, marvelmind_ros2_msgs, msg, HedgePosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, marvelmind_ros2_msgs, msg, HedgePosition)),
  }
};
...
{
  return &::marvelmind_ros2_msgs::msg::rosidl_typesupport_cpp::HedgePosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, marvelmind_ros2_msgs, msg, HedgePosition)() {
  return get_message_type_support_handle<marvelmind_ros2_msgs::msg::HedgePosition>();
}
